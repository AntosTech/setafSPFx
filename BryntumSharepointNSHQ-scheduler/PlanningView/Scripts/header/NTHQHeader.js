import NTHQSearch from './NTQHSearch.js';
import NTHQRange from './NTHQRange.js';
import NTHQSort from "./NTHQSort.js";
...
import NTHQExport from "./NTHQExport";
...
export default class NTHQHeader {
    ...
    constructor(app, scheduler) {
        ...
        me.export = new NTHQExport(app, scheduler);
        me.eventTypelegend = new NTHQEventTypeLegend(app, scheduler);
        me.eventTagLegend = new NTHQEventTagLegend(app, scheduler);

        me.range = new NTHQRange(app, scheduler);
        me.sort = new NTHQSort(app, scheduler);
        me.search = new NTHQSearch(app, scheduler);
    }
