...
- `calendar.stockholm.css` contains the scheduler markup and need to be imported in `\Pages\Default.aspx` like `<link rel="Stylesheet" type="text/css" href="../Content/calendar/calendar.stockholm.css" />`
