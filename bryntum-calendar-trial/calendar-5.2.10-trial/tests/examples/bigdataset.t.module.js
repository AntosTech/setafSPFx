import { Rectangle } from '../../build/calendar.module.js';
    ...
    t.it('Sanity', async t => {
        ...
        t.chain(
            ...
            () => {
                const
                    { activeView } = calendar,
                    { overflowPopup } = activeView.allDayEvents;

                // The +n more button takes up the whole width, and with only 768 pixels of height
