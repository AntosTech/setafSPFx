...
StartTest(t => {
  t.it('Sanity', t => {
    t.chain({
      ...
      click: '[data-ref="modeSelector"] button[data-ref=monthShowButton]'
    },
  ...
  t.it('Zero length allDay events', async t => {
    ...
    t.selectorExists('[data-ref="datePicker"] .b-calendar-cell[data-date="2020-05-25"] .b-cal-minimal-event-container.b-datepicker-1-to-3-events');
    ...
    await t.click('[data-ref="modeSelector"] button[data-ref=weekShowButton]');
