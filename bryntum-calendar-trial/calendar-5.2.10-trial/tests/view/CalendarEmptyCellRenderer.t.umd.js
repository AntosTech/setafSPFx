...
StartTest(t => {
  ...
  t.it('As a string value', async t => {
    ...
    await t.waitFor(() => {
      ...
      return (_calendar$features$ev = calendar.features.eventEdit._editor) === null || _calendar$features$ev === void 0 ? void 0 : _calendar$features$ev.containsFocus;
    });
  ...
  t.it('As an object', async t => {
    ...
    await t.waitFor(() => {
      ...
      return (_calendar$features$ev2 = calendar.features.eventEdit._editor) === null || _calendar$features$ev2 === void 0 ? void 0 : _calendar$features$ev2.containsFocus;
    });
    await t.type(null, 'Test new[ENTER]');
    t.selectorCountIs('.b-dayview-allday.b-calendar-cell .b-cal-cell-no-content:contains(No events)', 6);
    await t.click('.b-dayview-allday.b-calendar-cell[data-date="2019-10-16"] .b-cal-cell-no-content');
  ...
  t.it('As a function name', async t => {
    ...
    await t.waitFor(() => {
      ...
      return (_calendar$features$ev3 = calendar.features.eventEdit._editor) === null || _calendar$features$ev3 === void 0 ? void 0 : _calendar$features$ev3.containsFocus;
    });
    await t.type(null, 'Test new[ENTER]');
    t.selectorCountIs('.b-dayview-allday.b-calendar-cell .b-cal-cell-no-content:contains(No events)', 6);
    await t.click('.b-dayview-allday.b-calendar-cell[data-date="2019-10-16"] .b-cal-cell-no-content');
  ...
  t.it('As a function', async t => {
    ...
    await t.waitFor(() => {
      ...
      return (_calendar$features$ev4 = calendar.features.eventEdit._editor) === null || _calendar$features$ev4 === void 0 ? void 0 : _calendar$features$ev4.containsFocus;
    });
    await t.type(null, 'Test new[ENTER]');
    t.selectorCountIs('.b-dayview-allday.b-calendar-cell .b-cal-cell-no-content:contains(No events)', 6);
    await t.click('.b-dayview-allday.b-calendar-cell[data-date="2019-10-16"] .b-cal-cell-no-content');
