...
StartTest(t => {
    ...
    t.it('Calendar should have minimum height', async t => {
        ...
        calendar = new Calendar({
            ...
            events   : [
                { name : 'Event 1', resourceId : 'hotel', startDate : '2021-05-06', endDate : '2021-05-07' },
                { name : 'Event 2', resourceId : 'hotel', startDate : '2021-05-06', endDate : '2021-05-07' },
                { name : 'Event 3', resourceId : 'hotel', startDate : '2021-05-06', endDate : '2021-05-07' },
                { name : 'Event 4', resourceId : 'hotel', startDate : '2021-05-06', endDate : '2021-05-07' }
            ],
            resources : [
                { id : 'hotel', name : 'Hotel' }
            ]
