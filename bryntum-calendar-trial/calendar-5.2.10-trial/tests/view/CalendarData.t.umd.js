...
StartTest(t => {
  ...
  t.it('sanity when loaded asynchronously', async t => {
    ...
    t.chain({
      ...
      t.ok(conferenceEls.length, 'Breakfast shown');
  ...
  t.it('Mode reordering', async t => {
    ...
    t.isDeeply(modeSelector.buttonBar.items.filter(i => {
      var _i$ref;
      return (_i$ref = i.ref) === null || _i$ref === void 0 ? void 0 : _i$ref.includes('ShowButton');
    }).map(i => i.ref.split('ShowButton')[0]), ['agenda', 'year', 'month', 'week', 'day']);
    modeSelector.minified = true;
    await t.click(modeSelector.button.element);
    t.isDeeply(modeSelector.button.menu.items.filter(i => {
      var _i$ref2;
      return (_i$ref2 = i.ref) === null || _i$ref2 === void 0 ? void 0 : _i$ref2.includes('ShowMenuItem');
    }).map(i => i.ref.split('ShowMenuItem')[0]), ['agenda', 'year', 'month', 'week', 'day']);
