...
StartTest(t => {
  ...
  const dayColumns = count => () => {
    var _el$parentElement, _el$closest, _el$closest2;
    const el = t.query('.b-dayview-day-detail[data-date=2020-10-28]')[0];
    rect = el === null || el === void 0 ? void 0 : el.getBoundingClientRect();
    const parentRect = el === null || el === void 0 ? void 0 : (_el$parentElement = el.parentElement) === null || _el$parentElement === void 0 ? void 0 : _el$parentElement.getBoundingClientRect();
    const percent = rect.width / parentRect.width * 100;
    const space = el === null || el === void 0 ? void 0 : (_el$closest = el.closest('.b-calendar')) === null || _el$closest === void 0 ? void 0 : _el$closest.getBoundingClientRect();
    const sidebar = t.rect('.b-sidebar');
    const content = el === null || el === void 0 ? void 0 : (_el$closest2 = el.closest('.b-dayview-day-content')) === null || _el$closest2 === void 0 ? void 0 : _el$closest2.getBoundingClientRect();
    if (sidebar) {
      space.width -= sidebar.width;
    }
    return Math.abs((space === null || space === void 0 ? void 0 : space.width) - (content === null || content === void 0 ? void 0 : content.width)) < TOL && Math.abs(percent - 100 / count) < TOL;
  };
  ...
  t.it('Should be responsive to resize', async t => {
    ...
    await t.waitFor(calendarWidth(737));
    ...
    t.isApproxPx(rect.width, 236, SIDEBAR_TOL, 'Sidebar has correct width');
