  ...
  t.it('Should select single events on click in a month overflow popup', async t => {
    ...
    t.chain({
      ...
      waitFor: () => {
        ...
        return ((_calendar$modes$month = calendar.modes.month._overflowPopup) === null || _calendar$modes$month === void 0 ? void 0 : _calendar$modes$month.containsFocus) && t.query('.b-cal-event-wrap.b-active', calendar.modes.month.overflowPopup.element) && calendar.selectedEvents.map(e => e.id)[0] === 1;
      },
      trigger: {
