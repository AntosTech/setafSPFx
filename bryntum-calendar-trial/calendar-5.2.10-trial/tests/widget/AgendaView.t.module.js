import { EventStore, ResourceStore, DomHelper, Rectangle } from '../../build/calendar.module.js';
...
StartTest(t => {
    ...
    t.it('sanity', async t => {
        ...
        t.selectorCountIs('.b-cal-event-icon', 33, 'All icons rendered');
        // Test fix for https://github.com/bryntum/support/issues/3417
        t.selectorCountIs('.b-cal-event-icon:visible', 22, 'Only custom allDay icons visible');
