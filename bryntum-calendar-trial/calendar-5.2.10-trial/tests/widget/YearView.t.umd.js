...
StartTest(t => {
  ...
  t.beforeEach(async () => {
    var _yearView, _yearView$destroy, _calendar;
    (_yearView = yearView) === null || _yearView === void 0 ? void 0 : (_yearView$destroy = _yearView.destroy) === null || _yearView$destroy === void 0 ? void 0 : _yearView$destroy.call(_yearView);
