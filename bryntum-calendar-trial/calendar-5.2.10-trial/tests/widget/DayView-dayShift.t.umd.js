...
StartTest(t => {
  ...
  t.it('should handle drag create', async t => {
    ...
    await t.dragBy('.b-dayview-day-detail[data-date="2021-03-23"]', [0, 6 * hourPx], null, null, null, true, ['50%', 2 * hourPx]);
  ...
  t.it('should handle dblclick create', async t => {
    ...
    await t.doubleClick('.b-dayview-day-detail[data-date="2021-03-23"]', null, null, null, ['50%', 6 * hourPx]);
