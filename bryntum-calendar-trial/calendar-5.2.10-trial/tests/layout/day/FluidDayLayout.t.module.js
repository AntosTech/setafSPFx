import { DayTime, FluidDayLayout, EventSorter, EventModel, DateHelper } from '../../../build/calendar.module.js';
...
StartTest(t => {
    ...
    let eventId = 0,
        dayTime, events, innerEl, items, layout, outerEl;
    ...
    t.describe('Simple', t => {
        t.it('should layout single item', t => {
            testLayout(t, [
                { s : '3:00', e : '6:00', top : 10, bottom : 25 }
            ]);
        });
        ...
        t.it('should layout items without clusters', t => {
            testLayout(t, [
                ...
                { c : 0, s : '3:00', e : '6:00',  top : 10, bottom : 25 },
                { c : 1, s : '6:00', e : '7:00',  top : 25, bottom : 30 },
                { c : 2, s : '8:00', e : '10:00', top : 35, bottom : 45 }
            ]);
        });
        ...
        t.it('should layout with clusters', t => {
            testLayout(t, [
                { s : '3:00', e : '6:00', top : 10, bottom : 25 },
                { s : '4:00', e : '8:00', top : 15, bottom : 35 },
                { s : '6:00', e : '7:00', top : 25, bottom : 30 }
            ]);
        });
    });
    ...
    t.describe('Overlapping', t => {
        const suite = (t, index, layoutConfig) => {
            t.it(`should handle single minor overlap`, t => {
                testLayout(t, index, [
                    { s : '9:00',  e : '12:00', top : 40, bottom : 55, left : 0,  right : 990 },
                    { s : '10:00', e : '13:00', top : 45, bottom : 60, left : 10, right : 995 }
                ], layoutConfig);
            });

            t.it(`should handle single major overlap`, t => {
                testLayout(t, index, [
                    { s : '9:00', e : '12:00', top : 40,   bottom : 55, left : 0,   right : [500, 990] },
                    { s : '9:30', e : '13:00', top : 42.5, bottom : 60, left : 500, right : 995 }
                ], layoutConfig);
            });

            t.it(`should handle multiple, simultaneous major overlapping events`, t => {
                testLayout(t, index, [
                    { s : '9:00', e : '14:00', top : 40, bottom : 65, left : 0,   right : [333, 985] },
                    { s : '9:00', e : '13:00', top : 40, bottom : 60, left : 333, right : [667, 990] },
                    { s : '9:00', e : '12:00', top : 40, bottom : 55, left : 667, right : [995, 995] }
                ], layoutConfig);
            });

            t.it(`should handle multiple minor overlapping events`, t => {
                testLayout(t, index, [
                    { s : '9:00',  e : '13:00', top : 40, bottom : 60, left : 0,  right : 980 },
                    { s : '10:00', e : '14:00', top : 45, bottom : 65, left : 10, right : 985 },
                    { s : '11:00', e : '15:00', top : 50, bottom : 70, left : 20, right : 990 },
                    { s : '12:00', e : '14:00', top : 55, bottom : 65, left : 30, right : 995 }
                ], layoutConfig);
            });

            t.it(`should handle multiple major overlapping events`, t => {
                testLayout(t, index, [
                    { s : '9:00', e : '14:00', top : 40,   bottom : 65, left : 0,   right : [250, 980] },
                    { s : '9:00', e : '13:00', top : 40,   bottom : 60, left : 250, right : [500, 985] },
                    { s : '9:30', e : '15:00', top : 42.5, bottom : 70, left : 500, right : [750, 990] },
                    { s : '9:30', e : '14:00', top : 42.5, bottom : 65, left : 750, right : [995, 995] }
                ], layoutConfig);
            });
            ...
            t.it(`should minimize overlap of sibling items`, t => {
                 ...
                 */
                testLayout(t, index, [
                    { s : '9:00',  e : '14:00', top : 40, bottom : 65, left : [0,  0,  0],  right : 990 },
                    { s : '10:00', e : '11:00', top : 45, bottom : 50, left : [10, 10, 10], right : 995 },  // minor
                    { s : '12:00', e : '13:00', top : 55, bottom : 60, left : [10, 10, 10], right : 995 }   // minor
                ], layoutConfig);
            });
            ...
            t.it(`should handle cascade of minor overlapping events when first root event is cleared`, t => {
                testLayout(t, index, [
                    ...
                    { s : '12:00', e : '14:00', top : 55, bottom : 65, left : 10, right : 990 },
                    { s : '13:00', e : '15:00', top : 60, bottom : 70, left : 20, right : 995 }
                ], layoutConfig);
            });
            ...
            t.it(`should escalate items to the root following major/minor overlap`, t => {
                 ...
                 */
                testLayout(t, index, [
                    { s : '9:30',  e : '12:00', top : 42.5, bottom : 55, left : 0,   right : [495, 980] },  // 0
                    { s : '10:00', e : '15:00', top : 45,   bottom : 70, left : 500, right : [990, 990] },  // 1
                    { s : '11:00', e : '17:00', top : 50,   bottom : 80, left : 10,  right : [500, 985] },  // 2
                    { s : '13:00', e : '16:00', top : 60,   bottom : 75, left : 510, right : [995, 995] }   // 3
                ], layoutConfig);
            });
            ...
            t.it(`should escalate item to a child of the root following minor/major overlap`, t => {
                ...
                testLayout(t, index, [
                    ...
                    { s : '10:00', e : '12:00', top : 45,   bottom : 55, left : 10,  right : [500, 990] },  // 1 (minor)
                    { s : '10:30', e : '14:00', top : 47.5, bottom : 65, left : 500, right : [995, 995] },  // 2 (major)
                    { s : '13:00', e : '16:00', top : 60,   bottom : 75, left : 10,  right : [500, 990] }   // 3 (minor)
                ], layoutConfig);
            });
            ...
            t.it(`should escalate item to a child of the root following minor/major/minor overlap`, t => {
                 ...
                 */
                testLayout(t, index, [
                    { s : '9:00',  e : '15:00', top : 40,   bottom : 70, left : 0,   right : [495, 980] },  // 0
                    { s : '10:00', e : '14:00', top : 45,   bottom : 65, left : 10,  right : [500, 985] },  // 1 (minor)
                    { s : '10:30', e : '13:00', top : 47.5, bottom : 60, left : 500, right : [990, 990] },  // 2 (major)
                    { s : '12:00', e : '15:00', top : 55,   bottom : 70, left : 510, right : [995, 995] },  // 3 (minor)
                    { s : '14:30', e : '16:00', top : 67.5, bottom : 75, left : 10,  right : [500, 985] }   // 4 (minor)
                ], layoutConfig);
            });
            ...
            t.it(`should escalate item to the root following minor/major overlap`, t => {
                 ...
                 */
                testLayout(t, index, [
                    { s : '9:00',  e : '12:00', top : 40,   bottom : 55, left : 0,   right : [495, 985] },  // 0
                    { s : '10:00', e : '11:00', top : 45,   bottom : 50, left : 10,  right : [500, 990] },  // 1 (minor)
                    { s : '10:30', e : '13:00', top : 47.5, bottom : 60, left : 500, right : [995, 995] },  // 2 (major)
                    { s : '12:00', e : '14:00', top : 55,   bottom : 65, left : 0,   right : [500, 990] }   // 3
                ], layoutConfig);
            });
            ...
            t.it(`should escalate item to the root following minor/major/minor overlap`, t => {
                ...
                testLayout(t, index, [
                    ...
                    { s : '10:00', e : '14:00', top : 45,    bottom : 65,   left : 10,  right : [500, 985] },   // 1 (minor)
                    { s : '10:30', e : '13:00', top : 47.5,  bottom : 60,   left : 500, right : [990, 990] },   // 2 (major)
                    { s : '12:00', e : '16:00', top : 55,    bottom : 75,   left : 510, right : [995, 995] },   // 3 (minor)
                    { s : '15:00', e : '17:00', top : 70,    bottom : 80,   left : 0,   right : [500, 985] }    // 4 (minor)
                ], layoutConfig);
            });
            ...
            t.it(`should escalate item to child of root following minor/major/minor/minor overlap`, t => {
                 ...
                 */
                testLayout(t, index, [
                    { s : '9:00',  e : '15:00', top : 40,    bottom : 70,   left : 0,   right : [490, 975] },   // 0
                    { s : '10:00', e : '14:00', top : 45,    bottom : 65,   left : 10,  right : [500, 985] },   // 1 (minor)
                    { s : '10:30', e : '13:00', top : 47.5,  bottom : 60,   left : 500, right : [990, 990] },   // 2 (major)
                    { s : '12:00', e : '16:00', top : 55,    bottom : 75,   left : 510, right : [995, 995] },   // 3 (minor)
                    { s : '14:15', e : '16:30', top : 66.25, bottom : 77.5, left : 10,  right : [495, 980] },   // 4 (minor)
                    { s : '15:00', e : '17:00', top : 70,    bottom : 80,   left : 20,  right : [500, 985] }    // 5 (minor)
                ], layoutConfig);
            });
            ...
            t.it(`should handle simultaneous event after escalating item multiple levels to be child of root`, t => {
                 ...
                 */
                testLayout(t, index, [
                    { s : '9:00',  e : '15:00', top : 40, bottom : 70, left : 0,   right : [485, 975, 490] },    // 0
                    { s : '10:00', e : '12:00', top : 45, bottom : 55, left : 10,  right : [490, 980, 495] },    // 1
                    { s : '11:00', e : '14:00', top : 50, bottom : 65, left : 20,  right : [495, 985, 500] },    // 2
                    { s : '13:00', e : '17:00', top : 60, bottom : 80, left : [30, 30, 10],  right : [500, 990, 495] }, // 3
                    { s : '13:00', e : '16:00', top : 60, bottom : 75, left : 500, right : [995, 995] }     // 4
                ], layoutConfig);
            });
            ...
            t.it(`should handle multiple simultaneous events after escalating item multiple levels to be child of root`, t => {
                 ...
                 */
                testLayout(t, index, [
                    { s : '9:00',  e : '15:00', top : 40, bottom : 70,   left : 0,            right : [318, 970, 323] },  // 0
                    { s : '10:00', e : '12:00', top : 45, bottom : 55,   left : 10,           right : [323, 975, 328] },  // 1
                    { s : '11:00', e : '14:00', top : 50, bottom : 65,   left : 20,           right : [328, 980, 333] },  // 2
                    { s : '13:00', e : '17:00', top : 60, bottom : 80,   left : [30, 30, 10], right : [333, 985, 328] },  // 3
                    { s : '13:00', e : '16:00', top : 60, bottom : 75,   left : 333,          right : [667, 990] },       // 4
                    { s : '13:00', e : '15:30', top : 60, bottom : 72.5, left : 667,          right : [995, 995] }        // 5
                ], layoutConfig);
            });
            ...
            t.it(`should handle simultaneous events after minor overlap of item multiply escalated to child of root`, t => {
                 ...
                 */
                testLayout(t, index, [
                    { s : '9:00',  e : '15:00', top : 40, bottom : 70, left : 0,            right : [480, 970, 490] },  // 0
                    { s : '10:00', e : '12:00', top : 45, bottom : 55, left : 10,           right : [485, 975, 495] },  // 1
                    { s : '11:00', e : '14:00', top : 50, bottom : 65, left : 20,           right : [490, 980, 500] },  // 2
                    { s : '13:00', e : '16:00', top : 60, bottom : 75, left : [30, 30, 10], right : [495, 985] },       // 3
                    { s : '14:00', e : '18:00', top : 65, bottom : 85, left : [40, 40, 20], right : [500, 990] },       // 4
                    { s : '14:00', e : '17:00', top : 65, bottom : 80, left : 500,          right : [995, 995] }        // 5
                ], layoutConfig);
            });
            ...
            t.it(`should detect cousin events in overlapping columns and indent accordingly`, t => {
                 ...
                 */
                testLayout(t, index, [
                    { s : '9:00',  e : '20:00', left : 0,    right : [328, 965] },  // 0
                    { s : '9:10',  e : '10:00', left : 333,  right : [667, 975] },  // 1
                    { s : '9:20',  e : '19:00', left : 667,  right : [980, 980] },  // 2

                    { s : '11:00', e : '12:00', left : 333, right : [667, 975] },   // 3
                    { s : '11:10', e : '12:00', left : 10,  right : [333, 970] },   // 4
                    { s : '11:20', e : '12:00', left : 677, right : [995, 995] },   // 5

                    { s : '13:00', e : '14:00', left : 333, right : [667, 975] },   // 6
                    { s : '13:10', e : '14:00', left : 10,  right : [333, 970] },   // 7
                    { s : '13:15', e : '16:00', left : 677, right : [985, 985, 995] },   // 8

                    { s : '15:00', e : '16:00', left : 333, right : [667, 975] },   // 9
                    { s : '15:00', e : '16:00', left : 10,  right : [333, 970] },   // 10
                    { s : '15:15', e : '17:30', left : [687, 687, 677], right : [990, 990] },   // 11

                    { s : '17:00', e : '18:00', left : 333, right : [667, 975] },   // 12
                    { s : '17:00', e : '18:00', left : 10,  right : [333, 970] },   // 13
                    { s : '17:00', e : '18:00', left : [697, 697, 677], right : [995, 995, 985] }    // 14
                ], layoutConfig);
            });
            ...
            t.it(`should use multiple levels of exposed columns in decreasing order`, t => {
                 ...
                 */
                testLayout(t, index, [
                    { s : '9:00', e : '15:00', top : 40,    bottom : 70, left : 0,    right : [200, 975] },    // 0
                    { s : '9:00', e : '10:00', top : 40,    bottom : 45, left : 200,  right : [400, 980] },    // 1
                    { s : '9:00', e : '10:00', top : 40,    bottom : 45, left : 400,  right : [600, 985] },    // 2
                    { s : '9:00', e : '10:00', top : 40,    bottom : 45, left : 600,  right : [800, 990] },    // 3
                    { s : '9:15', e : '15:00', top : 41.25, bottom : 70, left : 800,  right : [995, 995] },    // 4

                    // Now the special cases:
                    { s : '10:00', e : '11:00', top : 45, bottom : 50, left : 200, right : [500, 985] },        // 5
                    { s : '10:00', e : '11:00', top : 45, bottom : 50, left : 500, right : [800, 990] },        // 6
                    { s : '11:00', e : '17:00', top : 50, bottom : 80, left : 200, right : [800, 990] }         // 7
                ], {
            ...
            t.it(`should use multiple levels of exposed columns in increasing order`, t => {
                ...
                testLayout(t, index, [
                    ...
                    { s : '9:15', e : '15:00', top : 41.25, bottom : 70, left : 400,  right : [600, 990] }, // 2

                    // Now the special cases:
                    { s : '10:00', e : '11:00', top : 45, bottom : 50, left : 200, right : [400, 990] },    // 3
                    { s : '10:00', e : '11:00', top : 45, bottom : 50, left : 600, right : [995, 995] },    // 4
                    { s : '11:00', e : '17:00', top : 50, bottom : 80, left : 200, right : [400, 990] },    // 5
                    { s : '11:00', e : '17:00', top : 50, bottom : 80, left : 600, right : [800, 990] },    // 6
                    { s : '11:00', e : '17:00', top : 50, bottom : 80, left : 800, right : [995, 995] }     // 7
                ], {
                    clearanceMinutes : 600,  // makes it easier to see vs packing everything in to < 45 min
                    ...layoutConfig
                });
            ...
            t.it(`should use exposed columns of subsequent events`, t => {
                 ...
                 */
                testLayout(t, index, [
                    { s : '9:00', e : '18:00', top : 40,    bottom : 85, left : 0,    right : [162, 970] },     // 0
                    { s : '9:00', e : '10:00', top : 40,    bottom : 45, left : 167,  right : [374, 980] },     // 1
                    { s : '9:00', e : '10:00', top : 40,    bottom : 45, left : 374,  right : [583, 985] },     // 2
                    { s : '9:00', e : '10:00', top : 40,    bottom : 45, left : 583,  right : [792, 990] },     // 3
                    { s : '9:15', e : '14:00', top : 41.25, bottom : 65, left : 792,  right : [995, 995] },     // 4

                    // Now the special cases:
                    { s : '10:00', e : '12:00', top : 45,   bottom : 55,   left : 167, right : [479, 985] },    // 5
                    { s : '10:30', e : '12:30', top : 47.5, bottom : 57.5, left : 479, right : [792, 990] },    // 6

                    { s : '12:30', e : '14:30', top : 57.5, bottom : 67.5, left : 167, right : [792, 990] },    // 7

                    { s : '15:00', e : '17:00', top : 70, bottom : 80, left : 167, right : [333, 975] },    // 8
                    { s : '15:00', e : '17:00', top : 70, bottom : 80, left : 333, right : [500, 980] },    // 9
                    { s : '15:00', e : '17:00', top : 70, bottom : 80, left : 500, right : [667, 985] },    // 10
                    { s : '15:00', e : '17:00', top : 70, bottom : 80, left : 667, right : [833, 990] },    // 11
                    { s : '15:00', e : '17:00', top : 70, bottom : 80, left : 10,  right : [167, 975] },    // 12
                    { s : '15:00', e : '17:00', top : 70, bottom : 80, left : 833, right : [995, 995] }     // 13
                ], {
