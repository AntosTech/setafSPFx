...
const
        ...
        const
            ...
            items      = [
                ...
                
                {
                    ...
                    items : [
                        {
                            alsoPreload : script(locales.map(l => `import "../lib/Calendar/localization/${l}.js";`)),
                            includeFor  : 'es6',
    ...
    preloadLocales          = {
        ...
        default : script([
            ...locales.map(l => `import ${l} from "../lib/Calendar/localization/${l}.js";`),
            'if (!window.bryntum.locales) window.bryntum.locales = {};',
            ...locales.map(l => `window.bryntum.locales.${l} = ${l};`)
        ])
    },
