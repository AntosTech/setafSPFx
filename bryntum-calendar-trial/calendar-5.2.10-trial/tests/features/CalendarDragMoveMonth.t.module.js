...
StartTest(t => {
    ...
    t.describe('Month View', t => {
        ...
        t.it('should abort drag operation on ESC keypress', async t => {
            ...
            t.expect(tentativeDates).toEqual([
                [new Date(2019, 9, 7), new Date(2019, 9, 13), h.Text.Hackathon],
                [new Date(2019, 9, 13), new Date(2019, 9, 15), h.Text.Hackathon]
            ]);
        ...
        t.it('Should scroll the view when dragging close to the edge', async t => {
            await h.init(t, {
                ...
                height : 300,
                events : [
                    { startDate : '2021-06-02', endDate : '2021-06-03', name : 'Event 1' }
                ]
            });
            ...
            t.is(event.endDate, new Date(2021, 5, 3), 'End date is ok');
        ...
        t.describe('One axis drag', t => {
            ...
            t.it('Should move multi-day event down one week', async t => {
                ...
                t.expect(tentativeDates).toEqual([
                    [new Date(2019, 9, 21), new Date(2019, 9, 27), h.Text.Hackathon],
                    [new Date(2019, 9, 27), new Date(2019, 9, 29), h.Text.Hackathon]
                ]);
            ...
            t.it('Should move events horizontally on an expanded row and then above and below', async t => {
                ...
                tentativeDates = h.getTentativeDates(/*includeTop=*/true);

                t.expect(tentativeDates).toEqual([
                    // retains top of event when dragging along origin week
                ...
                t.expect(tentativeDates).toEqual([
                    // retains top of event while still dragging inside origin week
                    [new Date(2019, 9, 17), new Date(2019, 9, 18), h.Text.Dinner3, 158]
                ]);
                ...
                t.expect(tentativeDates).toEqual([
                    // does not retain top of event on other weeks:
            ...
            t.it('Should move multi-day event right one day', async t => {
                ...
                t.expect(tentativeDates).toEqual([
                    [new Date(2019, 9, 15), new Date(2019, 9, 20), h.Text.Hackathon],
                    [new Date(2019, 9, 20), new Date(2019, 9, 23), h.Text.Hackathon]
                ]);
            ...
            t.it('Should move multi-day event left one day RTL', async t => {
            ...
            t.it('Should move multi-day event left one day', async t => {
                ...
                t.expect(tentativeDates).toEqual([
                    ...
                    [new Date(2019, 9, 20), new Date(2019, 9, 21), h.Text.Hackathon]
                ]);
            ...
            t.it('Should move multi-day event right one day RTL', async t => {
                await h.init(t, { rtl : true });
        ...
        t.describe('Two axis drag', t => {
            t.it('Should move multi-day event up one week and left one day', async t => {
                ...
                t.expect(tentativeDates).toEqual([
                    [new Date(2019, 9, 6), new Date(2019, 9, 13), h.Text.Hackathon],
                    [new Date(2019, 9, 13), new Date(2019, 9, 14), h.Text.Hackathon]
                ]);
            ...
            t.it('Should move multi-day event up one week and right one day', async t => {
                ...
                t.expect(tentativeDates).toEqual([
                    [new Date(2019, 9, 8), new Date(2019, 9, 13), h.Text.Hackathon],
                    [new Date(2019, 9, 13), new Date(2019, 9, 16), h.Text.Hackathon]
                ]);
            ...
            t.it('Should move multi-day event down one week and left one day', async t => {
                ...
                t.expect(tentativeDates).toEqual([
                    [new Date(2019, 9, 20), new Date(2019, 9, 27), h.Text.Hackathon],
                    [new Date(2019, 9, 27), new Date(2019, 9, 28), h.Text.Hackathon]
                ]);
            ...
            t.it('Should move multi-day event down one week and right one day', async t => {
                ...
                t.expect(tentativeDates).toEqual([
                    [new Date(2019, 9, 22), new Date(2019, 9, 27), h.Text.Hackathon],
                    [new Date(2019, 9, 27), new Date(2019, 9, 30), h.Text.Hackathon]
                ]);
        ...
        t.describe('Hidden nonworking days', t => {
            t.it('Should move single-day event up one week', async t => {
                ...
                t.expect(tentativeDates).toEqual([
                    [new Date(2019, 9, 7), new Date(2019, 9, 8), h.Text.BeerTime]
                ]);
            ...
            t.it('Should move single-day event up one week and then to the end of the working week', async t => {
                ...
                t.expect(tentativeDates).toEqual([
                    [new Date(2019, 9, 11), new Date(2019, 9, 12), h.Text.BeerTime]
                ]);
            ...
            t.it('Should move single-day event up one week and then to the end of the working week RTL', async t => {
                await h.init(t, {
                    rtl   : true,
                    modes : {
                        month : {
    ...
    t.describe('Month View Overflow', t => {
        ...
        t.it('should abort drag operation on ESC keypress', async t => {
            ...
            t.expect(tentativeDates).toEqual([
                [new Date(2019, 9, 11), new Date(2019, 9, 12), h.Text.TeamScrum]
            ]);
        ...
        t.it('Should drag an inter-day event out of overflow to new date', async t => {
            ...
            t.expect(tentativeDates).toEqual([
                [new Date(2019, 9, 11), new Date(2019, 9, 13), h.Text.BeerTime]
            ]);
    ...
    t.it('Draging item from overflowpopup should not have any proxy element', async t => {
        ...
        t.selectorNotExists('.b-monthview .b-content-element .b-cal-drag-proxy', 'It does not have any proxy element');
    });
});
