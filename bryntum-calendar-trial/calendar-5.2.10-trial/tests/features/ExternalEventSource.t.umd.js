...
StartTest(t => {
  ...
  t.beforeEach(t => {
    var _grid, _harness;
    (_grid = grid) === null || _grid === void 0 ? void 0 : _grid.destroy();
    (_harness = harness) === null || _harness === void 0 ? void 0 : _harness.destroy();
    harness = null;
    t.clearPageScroll();
  });
  async function setup(setupFn, extraConfig) {
    const useGrid = extraConfig === null || extraConfig === void 0 ? void 0 : extraConfig.grid;
  ...
  t.describe('DayView', t => {
    t.it('All day row should work', async t => {
      ...
      await harness.dragDrop(grid.getCell({
        row: 0,
        column: 0
      }), {
