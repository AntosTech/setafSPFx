    ...
    t.it('Print Day View', async t => {
        ...
        t.chain(
            next => {
                ...
                calendar.features.print.print({ debug : true });
            },
            next => {
                t.setIframe({
                    html : page,
                    onload(doc, frame) {
                        ...
                        t.is(doc.querySelectorAll('.b-timeaxis-container .b-dayview-timeaxis-time').length, 24, '24 exported time cells found');
            ...
            next => {
                t.setIframe({
                    ...
                    onload(doc, frame) {
                        ...
                        const dayElements = doc.querySelectorAll('.b-cal-agenda-date-date-number');
                        const startDay = 14;
