import { EventStore, ResourceStore, Calendar, DomHelper, DateHelper, EventModel } from '../../build/calendar.module.js';
...
StartTest(t => {
    ...
    t.it('Should be possible to edit an event to end at midnight', async t => {
        ...
        // Event editor shown is pass condition. Bug was a JS error thrown.
        await t.waitFor(() => eventEdit._editor?.containsFocus);
    ...
    t.it('Should be possible augment the filters of the resourceField', async t => {
        ...
        const
            { resourceField } = calendar.features.eventEdit.editor.widgetMap,
            { store }         = resourceField;
