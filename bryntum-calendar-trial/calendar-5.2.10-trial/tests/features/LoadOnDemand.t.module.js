...
StartTest(async t => {
    ...
    t.it('Dynamically loaded events', async t => {
        ...
        await t.waitFor(() => !calendar.crudManager.activeRequests.load);
        await clickCalendarElement(t, calendar.widgetMap.weekShowButton.element);
        ...
        // Go to October 2019
        await clickCalendarElement(t, calendar.widgetMap.monthShowButton.element);
        await t.waitForEvent(calendar, 'activeItemChange');
        await t.waitFor(() => calendar.activeView.refreshCount === lastRefreshCount + 2);
        ...
        // Go to 2019
        await clickCalendarElement(t, calendar.widgetMap.yearShowButton.element);
        await calendar.await('activeItemChange');
        await t.waitFor(() => calendar.activeView.refreshCount === lastRefreshCount + 3);
        ...
        await clickCalendarElement(t, calendar.widgetMap.dayShowButton.element);
        await calendar.await('activeItemChange');
        await t.waitFor(() => calendar.activeView.refreshCount === lastRefreshCount + 2);
        ...
        await clickCalendarElement(t, calendar.widgetMap.agendaShowButton.element);
        await calendar.await('activeItemChange');
        await t.waitFor(() => calendar.activeView.refreshCount === lastRefreshCount + 2);
    ...
    t.it('Should reload current range', async t => {
        ...
        await t.waitForEvent(calendar.crudManager, 'requestDone');
    });
});
