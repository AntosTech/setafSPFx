...
StartTest(t => {
  ...
  t.describe('All Day', t => {
    ...
    t.it('Should allow drag change of startDate back and forward', async t => {
      ...
      t.isDeeply(tentativeDates, [[new Date(2019, 9, 13), new Date(2019, 9, 20), 'Hackathon 2019']]);
      await h.moveCursorBy(3 * h.WEEK_PX_PER_DAY, 0);
      t.is(eventRecord.startDate, new Date(2019, 9, 14), 'Same startDate during drag');
      t.is(tentativeEvent.startDate, new Date(2019, 9, 16), 'Correct startDate during drag');
      tentativeDates = h.getTentativeDates();
      t.isDeeply(tentativeDates, [[new Date(2019, 9, 16), new Date(2019, 9, 20), 'Hackathon 2019']]);
      await h.drop();
    ...
    t.it('Should restrict drag of startDate to endDate', async t => {
      ...
      t.is(tentativeEvent.startDate, new Date(2019, 9, 13), 'Correct startDate during drag');
      tentativeDates = h.getTentativeDates();
      t.isDeeply(tentativeDates, [[new Date(2019, 9, 13), new Date(2019, 9, 15), 'Relax and official arrival beer']]);
      await h.moveCursorBy(3 * h.WEEK_PX_PER_DAY, 0);
      t.is(eventRecord.startDate, new Date(2019, 9, 14), 'Same startDate during drag');
      t.is(tentativeEvent.startDate, new Date(2019, 9, 14), 'Correct startDate during drag');
      tentativeDates = h.getTentativeDates();
      t.isDeeply(tentativeDates, [[new Date(2019, 9, 14), new Date(2019, 9, 15), 'Relax and official arrival beer']]);
      await h.drop();
      t.is(h.isHovering(el), '', 'Hovering ended');
    ...
    t.it('Should be able to drag endDate', async t => {
      ...
      tentativeDates = h.getTentativeDates();
      t.isDeeply(tentativeDates, [[new Date(2019, 9, 14), new Date(2019, 9, 17), 'Relax and official arrival beer']]);
      await h.drop();
      t.is(h.isHovering(el), '', 'Hovering ended');
  ...
  t.describe('Day Detail', t => {
    ...
    t.it('Should drag start date into previous day', async t => {
      ...
      t.isDeeply(tentativeDates, [[new Date(2019, 9, 14), new Date(2019, 9, 16), ''], [new Date(2019, 9, 14, 9), new Date(2019, 9, 15), '9 AMTeam Scrum'], [new Date(2019, 9, 15), new Date(2019, 9, 15, 12), '9 AMTeam Scrum12 PM']]);
      await h.drop();
    ...
    t.it('Should drag end date into next day', async t => {
      ...
      tentativeDates = h.getTentativeDates(false);
      t.isDeeply(tentativeDates, [[new Date(2019, 9, 15), new Date(2019, 9, 17), ''], [new Date(2019, 9, 15, 10), new Date(2019, 9, 16), '10 AMTeam Scrum'], [new Date(2019, 9, 16), new Date(2019, 9, 16, 8), '10 AMTeam Scrum8 AM']]);
      await h.drop();
