...
StartTest(t => {
  ...
  t.describe('All Day', t => {
    ...
    t.it('Should drag multi-day event correctly even if crossing in/out of day details', async t => {
      ...
      t.ok(eventRecord.allDay, 'Correct allDay');
      [el, offset] = await h.hoverEvent(eventRecord.id, {
        offset: [h.WEEK_PX_PER_DAY * 2.5, '50%']
      });
      await h.drag(el, {
        offset,
        by: [0, 100]
    ...
    t.it('Should drag event from overflow popup', async t => {
      ...
      t.ok(t.isDragging(), 'Drag is active');
      tentativeDates = h.getTentativeDates();
      t.expect(tentativeDates).toEqual([[new Date(2019, 9, 16), new Date(2019, 9, 17), 'Extra event 3']]);
      await h.drop();
      t.notOk(t.isDragging(), 'Drag is done');
      t.is(eventRecord.startDate, new Date(2019, 9, 16), 'Correct startDate');
      t.is(eventRecord.endDate, new Date(2019, 9, 17), 'Correct endDate');
  ...
  t.describe('Day Detail', t => {
    ...
    t.describe('showAllDayHeader: false', t => {
      ...
      t.it('Should support drag move for an interday event', async t => {
        ...
        tentativeDates = h.getTentativeDates();
        t.expect(tentativeDates).toEqual([[new Date(2019, 9, 18, 10), new Date(2019, 9, 19, 0), `10 AM${h.Text.Excursion}`], [new Date(2019, 9, 19, 0), new Date(2019, 9, 20, 0), `10 AM${h.Text.Excursion}4 PM`]]);
        ...
        tentativeDates = h.getTentativeDates();
        t.expect(tentativeDates).toEqual([[new Date(2019, 9, 15, 12), new Date(2019, 9, 16, 0), `12 PM${h.Text.Excursion}`], [new Date(2019, 9, 16, 0), new Date(2019, 9, 17, 0), `12 PM${h.Text.Excursion}`], [new Date(2019, 9, 17, 0), new Date(2019, 9, 17, 18), `12 PM${h.Text.Excursion}6 PM`]]);

        // Move 3 more days left to clip the startDate off:
        await t.moveCursorBy([-3 * h.WEEK_PX_PER_DAY, 0 * h.DAY_PX_PER_HOUR]);
        tentativeDates = h.getTentativeDates();
        t.expect(tentativeDates).toEqual([[new Date(2019, 9, 13, 0), new Date(2019, 9, 14, 0), `12 PM${h.Text.Excursion}`], [new Date(2019, 9, 14, 0), new Date(2019, 9, 14, 18), `12 PM${h.Text.Excursion}6 PM`]]);
      ...
      t.it('Should support drag resize on the bottom for an interday event', async t => {
        ...
        await t.moveCursorBy([-1 * h.WEEK_PX_PER_DAY, -2 * h.DAY_PX_PER_HOUR]);
        tentativeDates = h.getTentativeDates();
        t.expect(tentativeDates).toEqual([[new Date(2019, 9, 17, 10), new Date(2019, 9, 17, 12), `10 AM${h.Text.Excursion}12 PM`]]);
      ...
      t.it('Should support drag resize on the top for an interday event', async t => {
        ...
        tentativeDates = h.getTentativeDates();
        t.expect(tentativeDates).toEqual([[new Date(2019, 9, 18, 11), new Date(2019, 9, 19, 0), `11 AM${h.Text.Excursion}`], [new Date(2019, 9, 19, 0), new Date(2019, 9, 19, 16), `11 AM${h.Text.Excursion}4 PM`]]);
    ...
    t.describe('Recurrence', t => {
      ...
      t.it('Should drag occurrence and modify all following event', async t => {
        ...
        // TODO t.ok(eventRecord.isModified, 'Record was changed');
  ...
  t.it('Dragging item from overflowpopup should be vetoed if draggable is false', async t => {
    var _calendar$features$dr, _calendar$features$dr2, _calendar$features$dr3, _calendar$features$dr4, _calendar$features$dr5, _calendar$features$dr6, _calendar$features$dr7, _calendar$features$dr8;
    ...
    t.ok((_calendar$features$dr = calendar.features.drag.zones.week.allDayZone) === null || _calendar$features$dr === void 0 ? void 0 : (_calendar$features$dr2 = _calendar$features$dr.overflow) === null || _calendar$features$dr2 === void 0 ? void 0 : _calendar$features$dr2.dragging, 'Drag zone created');
    await t.mouseUp();
    t.selectorNotExists('.b-cal-tentative-event', 'Dragging is finished');
    t.notOk((_calendar$features$dr3 = calendar.features.drag.zones.week.allDayZone) === null || _calendar$features$dr3 === void 0 ? void 0 : (_calendar$features$dr4 = _calendar$features$dr3.overflow) === null || _calendar$features$dr4 === void 0 ? void 0 : _calendar$features$dr4.dragging, 'Drag zone removed');
    ...
    t.notOk((_calendar$features$dr5 = calendar.features.drag.zones.week.allDayZone) === null || _calendar$features$dr5 === void 0 ? void 0 : (_calendar$features$dr6 = _calendar$features$dr5.overflow) === null || _calendar$features$dr6 === void 0 ? void 0 : _calendar$features$dr6.dragging, 'No drag zone created');
    await t.dragBy({
    ...
    t.selectorNotExists('.b-cal-tentative-event', 'Dragging is vetoed');
    t.notOk((_calendar$features$dr7 = calendar.features.drag.zones.week.allDayZone) === null || _calendar$features$dr7 === void 0 ? void 0 : (_calendar$features$dr8 = _calendar$features$dr7.overflow) === null || _calendar$features$dr8 === void 0 ? void 0 : _calendar$features$dr8.dragging, 'No drag zone created');
  });
});