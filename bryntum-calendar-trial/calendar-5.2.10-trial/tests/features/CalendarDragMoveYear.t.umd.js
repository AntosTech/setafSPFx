...
StartTest(t => {
  ...
  t.it('Should drag an intra-day event out of overflow to new date RTL', async t => {
    await h.init(t, {
      rtl: true
    });
    overflow = await h.overflowPopup('2019-10-15');
  ...
  t.it('Should drag an inter-day event out of overflow to new date RTL', async t => {
    await h.init(t, {
      rtl: true
    });
    overflow = await h.overflowPopup('2019-10-15');
  ...
  t.it('should abort drag operation on ESC keypress', async t => {
    ...
    // Wait for focus to have left the overflow popup
