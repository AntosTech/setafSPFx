...
StartTest(t => {
    ...
    t.it('WeekExpander feature', async t => {
        ...
        const
            weekRow = calendar.modes.month.weekElements[2],
        ...
        // It's been shrinkwrapped
        await t.waitForSelector('[data-week="2019,42"].b-shrinkwrapped');
        ...
        // Also expand week 43
        await t.click('[data-week="2019,43"] .b-week-toggle-tool');

        // It's been shrinkwrapped
        await t.waitForSelector('[data-week="2019,43"].b-shrinkwrapped');

        // Wait for the transition to finish
        await t.waitForAnimations();

        // https://github.com/bryntum/support/issues/3696
        ...
        // It's been flexed
        await t.waitForSelector('[data-week="2019,42"]:not(.b-shrinkwrapped)');
        ...
        // It's been flexed
        await t.waitForSelector('[data-week="2019,43"]:not(.b-shrinkwrapped)');
        ...
        await t.click('[data-date="2019-10-14"] .b-cal-cell-overflow');
        ...
        calendar.modes.month.autoRowHeight = true;
        ...
        calendar.modes.month.autoRowHeight = false;
