...
StartTest(t => {
  ...
  t.it('MonthView', async t => {
    ...
    await t.waitFor(() => {
      var _calendar$activeView$;
      return (_calendar$activeView$ = calendar.activeView._overflowPopup) === null || _calendar$activeView$ === void 0 ? void 0 : _calendar$activeView$.containsFocus;
    });
  ...
  t.it('should hide tools which are not available', async t => {
    ...
    await t.waitFor(() => {
      var _calendar$features$ev7;
      return (_calendar$features$ev7 = calendar.features.eventMenu.menu) === null || _calendar$features$ev7 === void 0 ? void 0 : _calendar$features$ev7.isVisible;
    });
    ...
    await t.rightClick('.b-cal-event');
    await t.waitFor(() => {
      var _calendar$features$ev8;
      return (_calendar$features$ev8 = calendar.features.eventMenu.menu) === null || _calendar$features$ev8 === void 0 ? void 0 : _calendar$features$ev8.isVisible;
    });
    ...
    await t.rightClick('.b-cal-event');
    await t.waitFor(() => {
      var _calendar$features$ev9;
      return (_calendar$features$ev9 = calendar.features.eventMenu.menu) === null || _calendar$features$ev9 === void 0 ? void 0 : _calendar$features$ev9.isVisible;
    });
    ...
    t.notOk((_calendar$features$ev10 = calendar.features.eventMenu.menu) === null || _calendar$features$ev10 === void 0 ? void 0 : _calendar$features$ev10.isVisible);
  });
});