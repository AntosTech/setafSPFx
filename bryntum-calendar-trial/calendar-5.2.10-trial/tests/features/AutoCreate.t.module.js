import { ResourceStore, EventStore } from '../../build/calendar.module.js';
...
StartTest(t => {
        ...
        calendar = await t.getCalendar({
            ...
            crudManager : {
                ...
                eventStore : new EventStore({
                    data : [
                        { name : '1', resourceId : 'bryntum', startDate : '2019-10-14T10:00:00', endDate : '2019-10-14T16:00:00' },
                        { name : '2', resourceId : 'bryntum', startDate : '2019-10-14T10:00:00', endDate : '2019-10-14T16:00:00' },
                        { name : '3', resourceId : 'bryntum', startDate : '2019-10-14T10:00:00', endDate : '2019-10-14T16:00:00' },
                        { name : '4', resourceId : 'bryntum', startDate : '2019-10-14T10:00:00', endDate : '2019-10-14T16:00:00' },
                        { name : '5', resourceId : 'bryntum', startDate : '2019-10-14T10:00:00', endDate : '2019-10-14T16:00:00' }
                    ]
                })
            }
        });
    ...
    t.it('Should sync newly created event record + assignment record after pressing save in event editor', async t => {
        ...
        // wait a bit more to ensure no other sync attempts are made
    ...
    // https://github.com/bryntum/support/issues/5347
    t.it('Should allow null defaultCalendar creating a new event', async t => {
        calendar = await t.getCalendar({
            date            : new Date(2019, 9, 14),
            mode            : 'week',
        ...
        await t.type(null, 'New Event');

        await t.click('button[data-ref="saveButton"]');

        t.notOk(calendar.eventStore.last.resource, 'defaultCalendar is null');
    });
});
