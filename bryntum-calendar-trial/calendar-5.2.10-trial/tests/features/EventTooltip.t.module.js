import { EventStore, ResourceStore, DateHelper, EventModel } from '../../build/calendar.module.js';
...
StartTest(t => {
    ...
    t.it('Should reveal events on click in weekview, if they are part of a cluster', async t => {
        ...
        t.chain(
            ...
            { click : '.b-cal-event-wrap:contains(Event 2)', offset : [10, 10] },
            async() => {
    ...
    t.it('should be able to use remote content as DomConfig', async t => {
        ...
        t.selectorExists('.b-eventtip div:textEquals(06 March 2020 at 18:00)', 'Tooltip from date from fetched content');
    });
    ...
    t.it('should be able to use remote content as HTML', async t => {
        ...
        t.is(calendar.features.eventTooltip.tooltip.bodyElement.innerHTML, '<h1 role="presentation" style="color: rgb(255, 255, 255);">The event name</h1><div class="b-tooltip-loading" style="display: grid; grid-template-columns: 4em 1fr;"><div role="presentation">From</div><div role="presentation">06 March 2020 at 18:00</div></div><div role="presentation" style="display: grid; grid-template-columns: 4em 1fr;"><div role="presentation">To</div><div role="presentation">06 March 2020 at 19:00</div></div>');
    });
});
