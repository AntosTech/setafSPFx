import { LocaleManager, DateHelper, ObjectHelper } from '../../build/calendar.module.js';
...
StartTest(t => {
    ...
    t.it('Should localize correctly', async t => {
        function assertWeekDay(desc) {
            t.subTest(desc, t => {
                const { weekStartDay, nonWorkingDays } = DateHelper;
    ...
    t.it('Should remove leading 0 in hour for US English locale', async t => {
        ...
        t.chain(
            ...
            { waitForSelector : '.b-weekview .b-dayview-timeaxis-time:regex(3\\sPM)', desc : 'Week view has time format correct' },
            { waitForSelector : '.b-weekview [data-event-id=1] .b-event-time:regex(3\\sPM)', desc : 'Event 1 on week view has time format correct' },
            { click : '.b-weekview [data-event-id=1]' },
            { waitForSelector : '.b-sch-event-tooltip .b-sch-clock-text:regex(3\\sPM)', desc : 'Tooltip on week view has time format correct' },

            { diag : 'checking day view' },
            { click : '[data-ref="dayShowButton"]' },
            { waitForSelector : '.b-dayview .b-dayview-timeaxis-time:regex(3\\sPM)', desc : 'Day view has time format correct' },
            { waitForSelector : '.b-dayview [data-event-id=1] .b-event-time:regex(3\\sPM)', desc : 'Event 1 on day view has time format correct' },
            { click : '.b-dayview [data-event-id=1]' },
            { waitForSelector : '.b-sch-event-tooltip .b-sch-clock-text:regex(3\\sPM)', desc : 'Tooltip on day view has time format correct' }
        );
    });
    ...
    t.it('Should format time correctly for SvSE locale', async t => {
        ...
        t.chain(
            ...
            { waitForSelector : '.b-weekview .b-dayview-timeaxis-time:contains(15:00)', desc : 'Week view has time format correct' },
            { waitForSelector : '.b-weekview [data-event-id=1] .b-event-time:contains(15:00)', desc : 'Event 1 on week view has time format correct' },
            { click : '.b-weekview [data-event-id=1]' },
            { waitForSelector : '.b-sch-event-tooltip .b-sch-clock-text:contains(15:00)', desc : 'Tooltip on week view has time format correct' },

            { diag : 'checking day view' },
            { click : '[data-ref="dayShowButton"]' },
            { waitForSelector : '.b-dayview .b-dayview-timeaxis-time:contains(15:00)', desc : 'Day view has time format correct' },
            { waitForSelector : '.b-dayview [data-event-id=1] .b-event-time:contains(15:00)', desc : 'Event 1 on day view has time format correct' },
            { click : '.b-dayview [data-event-id=1]' },
            { waitForSelector : '.b-sch-event-tooltip .b-sch-clock-text:contains(15:00)', desc : 'Tooltip on day view has time format correct' }
        );
    });
