...
StartTest(t => {
  ...
  t.it('Should remove leading 0 in hour for US English locale', async t => {
    ...
    t.chain({
      ...
      waitForSelector: '.b-weekview .b-dayview-timeaxis-time:regex(3\\sPM)',
      desc: 'Week view has time format correct'
    }, {
      waitForSelector: '.b-weekview [data-event-id=1] .b-event-time:regex(3\\sPM)',
      desc: 'Event 1 on week view has time format correct'
    }, {
      click: '.b-weekview [data-event-id=1]'
    }, {
      waitForSelector: '.b-sch-event-tooltip .b-sch-clock-text:regex(3\\sPM)',
      ...
      waitForSelector: '.b-dayview .b-dayview-timeaxis-time:regex(3\\sPM)',
      desc: 'Day view has time format correct'
    }, {
      waitForSelector: '.b-dayview [data-event-id=1] .b-event-time:regex(3\\sPM)',
