...
StartTest(t => {
  ...
  const {
    ...
    optionalKeys = {
      ...
      PresetManager: ['secondAndMinute', 'minuteAndHour', 'hourAndDay', 'dayAndWeek', 'weekAndDay', 'day', 'week', 'dayAndMonth', 'weekAndMonth', 'weekAndDayLetter', 'weekDateAndMonth', 'monthAndYear', 'year', 'manyYears'],
