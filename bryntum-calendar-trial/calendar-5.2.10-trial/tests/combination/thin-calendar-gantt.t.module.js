import { Calendar, Gantt, ProjectModel, DomHelper } from '../../build/calendar.module.js';
...
StartTest(t => {
    ...
    t.it('Calendar + Gantt with thin bundle sanity', async t => {
            ...
            tasks : [
                {
                    ...
                    expanded : true,
                    children : [
                        { id : 2, name : 'Event 1', startDate : '2022-02-11T8', duration : 5, durationUnit : 'h' },
                        { id : 3, name : 'Event 2', startDate : '2022-02-11T8', duration : 5, durationUnit : 'h' }
                    ]
                }
            ],
        ...
        t.selectorCountIs('.b-cal-event', 2, 'Calendar events rendered (no parent)');
