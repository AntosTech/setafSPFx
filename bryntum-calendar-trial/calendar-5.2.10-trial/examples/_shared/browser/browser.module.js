import { Store, AjaxHelper, BrowserHelper, DomHelper, DomSync, EventHelper, Toolbar, Popup, Widget, GlobalEvents, VersionHelper, FunctionHelper } from '../../../build/calendar.module.js';
    ...
    getDomConfig() {
        ...
        me.examplesStore.records.forEach(example => {
            if (example.isSpecialRow) {
                ...
                const
                    hasPopup = (example.build && !me.isOnline) || example.offline,
                    id       = example.id,
