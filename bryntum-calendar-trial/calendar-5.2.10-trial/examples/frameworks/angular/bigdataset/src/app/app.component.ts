...
export class AppComponent implements AfterViewInit {
    ...
    onAutoRowHeightChanged({ checked } : { checked: boolean }): void {
        // @ts-ignore Remove ignore after 5.1,
    ...
    ngAfterViewInit(): void {
        ...
        autoRowHeight.on({ change : this.onAutoRowHeightChanged, thisObj : this });
        resourceFilterFilter.on({ change : this.onResourceFilterFilterChange, thisObj : this });
    }
}
