import { DateHelper, Calendar, DomHelper, StringHelper } from '../../build/calendar.module.js';
...
const calendar = new Calendar({
    ...
    log(message) {
        const logEl = this.widgetMap.eventLog.contentElement;
    ...
    listeners : {
        ...
        viewPaint({ source : view }) {
            ...
            // Do some logging just for demo purposes
            view.parent.parent.log(`${view.title}View activated`);
        ...
        navigate({ item }) {
            const
                newRecord = item && calendar.activeView.getEventRecord(item),
