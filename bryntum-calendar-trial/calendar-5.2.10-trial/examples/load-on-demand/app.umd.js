...
shared.mockUrl('dynamic-load', (url, urlParams, {
  queryParams
}) => {
  var startDate = DateHelper.parseKey(queryParams.startDate),
...
shared.mockUrl('dynamic-load-sync', (url, urlParams, {
  body,
  queryParams
}) => {
  ...
  removed === null || removed === void 0 ? void 0 : removed.forEach(e => {
    // load handler filters these out
    sourceRecords[e.id].removed = true;
  });
  added === null || added === void 0 ? void 0 : added.forEach(e => {
