import { EventModel, Combo, ResourceStore, Calendar, CalendarStores, Grid, DateHelper, Month, CrudManager, DomSync, StringHelper } from '../../build/calendar.module.js';
...
class WeekGrid extends Grid.mixin(CalendarStores) {
    ...
    getEventRecord(elementOrEvent) {
        ...
        element = element?.closest('[data-id]') || null;

        return element && this.store.getById(element.dataset.id);
    }
