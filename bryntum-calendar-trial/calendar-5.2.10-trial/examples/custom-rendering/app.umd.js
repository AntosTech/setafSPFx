...
class WeekGrid extends Grid.mixin(CalendarStores) {
  ...
  getEventRecord(elementOrEvent) {
    var _element;
    var element = elementOrEvent instanceof Event ? elementOrEvent.target : elementOrEvent;
    element = ((_element = element) === null || _element === void 0 ? void 0 : _element.closest('[data-id]')) || null;
