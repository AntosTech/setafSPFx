...
```shell
$ yarn add @bryntum/calendar@npm:@bryntum/calendar-trial@5.2.10
$ yarn add @bryntum/calendar-angular@5.2.10
```
...
"dependencies": {
  ...
  "@bryntum/calendar-angular": "5.2.10"
}
```
...
the licensed `calendar` package. This means there is no need to change your application code after getting a license,
...
```json
  "dependencies": {
    ...
    "@bryntum/calendar": "file:./lib/bryntum-calendar-trial-5.2.10.tgz"
}
```

<div class="note">

Please note that <strong>@bryntum/calendar-trial-lib</strong> is a required internal package which is used for product
installation and should be installed first. Place it above <strong>@bryntum/calendar</strong> in the <strong>package.json</strong> file.
...
```json
  "dependencies": {
    ...
    "@bryntum/calendar": "file:./lib/bryntum-calendar-5.2.10.tgz"
}
```

<div class="note">

Please note that <strong>@bryntum/calendar-lib</strong> is a required internal package which is used for product
installation and should be installed first. Place it above <strong>@bryntum/calendar</strong> in the <strong>package.json</strong> file.
...
npm ERR! 404
npm ERR! 404 ‘@bryntum/calendar@5.2.10’ is not in the npm registry.
```
