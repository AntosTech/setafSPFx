...
<a href="https://bryntum.com/products/scheduler/examples/#Integration/Vue" class="b-card"><i class="fas b-fa-globe"></i>View online Vue demos</a>
...
$ npm install @bryntum/scheduler-vue-3@5.2.10
```
...
```shell
$ npm install @bryntum/scheduler@5.2.10 
$ npm install @bryntum/scheduler-vue-3@5.2.10
```
</div>
</div>
