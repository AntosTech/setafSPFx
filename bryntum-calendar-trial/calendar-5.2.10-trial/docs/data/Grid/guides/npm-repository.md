...
|--------------------|------------------------------|---------------------------------------------------------------------------|
| Angular            | **@bryntum/grid-angular** | [Angular integration guide](#Grid/guides/integration/angular/guide.md) |
...
```shell
$ yarn add @bryntum/grid@npm:@bryntum/grid-trial@5.2.10
$ yarn add @bryntum/grid-angular@5.2.10
```
...
To install other Bryntum trial products, simply replace the product identifier `grid-trial` with `gantt-trial`, 
...
To install other Bryntum products, simply replace the product identifier `grid` with `gantt`, `scheduler`,
...
```json
  "dependencies": {
    ...
    "@bryntum/grid": "file:./lib/bryntum-grid-trial-5.2.10.tgz"
}
```
...
```json
  "dependencies": {
    ...
    "@bryntum/grid": "file:./lib/bryntum-grid-5.2.10.tgz"
}
```
...
npm ERR! 404
npm ERR! 404 ‘@bryntum/grid@5.2.10’ is not in the npm registry.
```
