...
<a href="https://bryntum.com/products/grid/examples/#Integration/Vue" class="b-card"><i class="fas b-fa-globe"></i>View online Vue demos</a>
...
$ npm install @bryntum/grid-vue-3@5.2.10
```
